...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parsy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13906&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parsy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parsy` can be installed with:

```
conda install parsy
```

It is possible to list all of the versions of `parsy` available on your platform with:
